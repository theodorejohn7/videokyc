...
export const DrawMesh = (left, right, predictions, ctx, maxValue) => {
  // console.log(left, right, predictions, ctx);
  ...
  if (predictions.length > 0) {
    predictions.forEach((prediction) => {
      ...
      for (let i = 0; i < keypoints.length; i++) {
        ...
        // Check if the current keypoint is the left eye iris or right eye iris
        // if (i === 468 || i === 469 || i === 470 || i === 471 || i === 472) {
        //   ctx.fillStyle = "red"; // Set color to red for left eye iris
        // } else if (
        //   i === 473 ||
        //   i === 474 ||
        //   i === 475 ||
        ...
        //   i === 477
        // ) {
        //   ctx.fillStyle = "white"; // Set color to dark blue for right eye iris
        // }
        // IRIS
        // ctx.strokeStyle = "red";
        // if (predictions.length > 0) {
        ...
        ctx.fillStyle =
          left >= maxValue && right >= maxValue ? "green" : "white";
        if (predictions.length > 0) {
          predictions.forEach((prediction) => {
        ...
        if (predictions.length > 0) {
          predictions.forEach((prediction) => {
            ...
            const rightEyeOutlinePoints = rightEyeUpper0.concat(rightEyeLower0);

            const leftEyeOutlinePoints = leftEyeUpper0.concat(leftEyeLower0);
            ...
            if (
              rightEyeCenterPointDistance < 7 ||
              leftEyeCenterPointDistance < 7
            ) {
              eyesClosed = 1;
            }
            ...
            //   ctx.fill();
            // });
            rightEyeOutlinePoints.forEach((point) => {
              ctx.fillStyle = right >= maxValue ? "green" : "white";
            ...
            leftEyeOutlinePoints.forEach((point) => {
              ctx.fillStyle = left >= maxValue ? "green" : "white";
